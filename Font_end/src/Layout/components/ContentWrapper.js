						...
						<div className="row">
							<div className="col-lg-3 col-6">
								...
								<div className="small-box bg-info">
									...
									<a href="%PUBLIC_URL%/#" className="small-box-footer">
                  ...
                  3
                    ...
                    <span className="direct-chat-name float-left">
                      ...
                      23 Jan 2:00 pm
												...
												<img
													...
													src="%PUBLIC_URL%/dist/img/user1-128x128.jpg"
                    ...
                    <span className="direct-chat-name float-right">
                      ...
                      23 Jan 2:05 pm
												...
												<img
													className="direct-chat-img"
													src="%PUBLIC_URL%/dist/img/user3-128x128.jpg"
													alt="message user image"
												/>
												{/* /.direct-chat-img */}
                          ...
                          How have you been? I was...
												...
												<li>
													<a href="%PUBLIC_URL%/#">
														<img
															className="contacts-list-img"
															src="%PUBLIC_URL%/dist/img/user7-128x128.jpg"
														/>
														<div className="contacts-list-info">
                        <span className="contacts-list-name">
                          Sarah Doe
                          ...
                          I'll call you back at...
												...
												<li>
													<a href="%PUBLIC_URL%/#">
														<img
															className="contacts-list-img"
															src="%PUBLIC_URL%/dist/img/user5-128x128.jpg"
														/>
														<div className="contacts-list-info">
                        <span className="contacts-list-name">
                          Nora S. Vans
                          ...
                          Where is your new...
												...
												<li>
													<a href="%PUBLIC_URL%/#">
														<img
															className="contacts-list-img"
															src="%PUBLIC_URL%/dist/img/user6-128x128.jpg"
														/>
														<div className="contacts-list-info">
                        <span className="contacts-list-name">
                          John K.
                          ...
                          Can I take a look at...
												...
												<li>
													<a href="%PUBLIC_URL%/#">
														<img
															className="contacts-list-img"
															src="%PUBLIC_URL%/dist/img/user8-128x128.jpg"
														/>
														<div className="contacts-list-info">
                        <span className="contacts-list-name">
                          Kenneth M.
										...
										<div className="card-tools">
											<ul className="pagination pagination-sm">
												<li className="page-item">
													<a href="%PUBLIC_URL%/#" className="page-link">
														«
													</a>
												</li>
												<li className="page-item">
										...
										<div className="card-tools">
											...
											<div className="btn-group">
												...
												<div className="dropdown-menu float-right" role="menu">
													<a href="%PUBLIC_URL%/#" className="dropdown-item">
														Add new event
													</a>
													<a href="%PUBLIC_URL%/#" className="dropdown-item">
														Clear events
